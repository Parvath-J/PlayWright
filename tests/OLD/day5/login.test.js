...
await expect(loginPage.page.locator('.oxd-input-field-error-message')).toContainText('Required');
});
...
await
expect(loginPage.page.locator('.orangehrm-forgot-password-title')).toContainText('Reset Password');
});
